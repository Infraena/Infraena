...
const DEMO_SERVICES = [
  {
    ...
    team: "demo-platform",
    repoUrl: "https://github.com/example/demo-auth-api",
    repoProvider: "github",
  ...
  },
  {
    ...
    languages: ["go"],
    team: "demo-platform",
    repoUrl: "https://github.com/example/demo-billing-api",
    repoProvider: "github",
    provisioning: ["github", "terraform", "vault"],
    status: "ready",
    healthUrl: "https://example.com",
  ...
  },
  {
    ...
    team: "demo-platform",
    repoUrl: "https://github.com/example/demo-web-app",
    repoProvider: "github",
    provisioning: ["github"],
    status: "ready",
    healthUrl: "https://example.com",
  },
  {
    ...
    slug: "demo-payments-api",
    description: "Payments API on GitLab (demo data)",
    category: "backend",
    languages: ["java"],
    team: "demo-platform",
    repoUrl: "https://gitlab.com/example/demo-payments-api",
    repoProvider: "gitlab",
    provisioning: ["gitlab", "terraform", "vault"],
    status: "ready",
  },
  {
    name: "demo-user-db",
    ...
    team: "demo-data",
    repoUrl: "https://github.com/example/demo-user-db",
    repoProvider: "github",
  ...
  },
  {
    ...
    languages: ["vue"],
    team: "demo-platform",
    repoUrl: "https://github.com/example/demo-legacy-app",
    repoProvider: "github",
    provisioning: [],
    status: "imported",
  },
  {
    ...
    languages: ["terraform"],
    team: "demo-data",
    repoUrl: "https://github.com/example/demo-analytics-worker",
    repoProvider: "github",
    provisioning: ["github", "terraform", "vault"],
    status: "failed",
  },
...
const JOB_TYPES = ["github", "gitlab", "terraform", "vault"] as const;
